...
public class ThreadImplementingRunnableInterface implements Runnable{
    ...
    public static void main(String[] args) {
        ThreadImplementingRunnableInterface obj = new ThreadImplementingRunnableInterface();
        Thread ThreadImplementingRunnableInterface = new Thread(obj);
        ThreadImplementingRunnableInterface.start();
    }
}